...
var renamedPackages = map[string]*packageRenames{
	"github.com/pendo-io/aws-sdk-go/service/autoscaling": {
	...
	"github.com/pendo-io/aws-sdk-go/service/autoscaling/autoscalingiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/pendo-io/aws-sdk-go/service/cloudformation": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
			"EventID":            "EventId",
	...
	"github.com/pendo-io/aws-sdk-go/service/cloudformation/cloudformationiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/pendo-io/aws-sdk-go/service/cloudfront/cloudfrontiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/pendo-io/aws-sdk-go/service/cloudhsm": {
		operations: map[string]string{
	...
	"github.com/pendo-io/aws-sdk-go/service/cloudhsm/cloudhsmiface": {
		operations: map[string]string{
			"CreateHAPG":          "CreateHapg",
			"CreateHAPGPages":     "CreateHapgPages",
			"CreateHAPGRequest":   "CreateHapgRequest",
	...
	"github.com/pendo-io/aws-sdk-go/service/cloudsearch": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
			"DomainID": "DomainId",
	...
	"github.com/pendo-io/aws-sdk-go/service/cloudsearch/cloudsearchiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/pendo-io/aws-sdk-go/service/cloudsearchdomain/cloudsearchdomainiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/pendo-io/aws-sdk-go/service/cloudtrail": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
	...
	"github.com/pendo-io/aws-sdk-go/service/cloudtrail/cloudtrailiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/pendo-io/aws-sdk-go/service/cloudwatch": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
			"AlarmARN": "AlarmArn",
	...
	"github.com/pendo-io/aws-sdk-go/service/cloudwatch/cloudwatchiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/pendo-io/aws-sdk-go/service/cloudwatchlogs/cloudwatchlogsiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/pendo-io/aws-sdk-go/service/codecommit": {
		operations: map[string]string{},
		shapes: map[string]string{
	...
	"github.com/pendo-io/aws-sdk-go/service/codecommit/codecommitiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/pendo-io/aws-sdk-go/service/codedeploy": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
	...
	"github.com/pendo-io/aws-sdk-go/service/codedeploy/codedeployiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/pendo-io/aws-sdk-go/service/codepipeline": {
		operations: map[string]string{},
		shapes: map[string]string{
	...
	"github.com/pendo-io/aws-sdk-go/service/codepipeline/codepipelineiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/pendo-io/aws-sdk-go/service/cognitoidentity/cognitoidentityiface": {
		operations: map[string]string{
			"GetID":                              "GetId",
			"GetIDPages":                         "GetIdPages",
			"GetIDRequest":                       "GetIdRequest",
	...
	"github.com/pendo-io/aws-sdk-go/service/cognitosync": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
	...
	"github.com/pendo-io/aws-sdk-go/service/cognitosync/cognitosynciface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/pendo-io/aws-sdk-go/service/configservice": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
			"ARN":                  "Arn",
	...
	"github.com/pendo-io/aws-sdk-go/service/configservice/configserviceiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/pendo-io/aws-sdk-go/service/datapipeline": {
		operations: map[string]string{},
		shapes: map[string]string{
	...
	"github.com/pendo-io/aws-sdk-go/service/datapipeline/datapipelineiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/pendo-io/aws-sdk-go/service/devicefarm": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
			"ARN":                 "Arn",
	...
	"github.com/pendo-io/aws-sdk-go/service/devicefarm/devicefarmiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/pendo-io/aws-sdk-go/service/directconnect": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
			"ASN":                "Asn",
	...
	"github.com/pendo-io/aws-sdk-go/service/directconnect/directconnectiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/pendo-io/aws-sdk-go/service/directoryservice": {
		operations: map[string]string{
	...
	"github.com/pendo-io/aws-sdk-go/service/directoryservice/directoryserviceiface": {
		operations: map[string]string{
			"DisableSSO":        "DisableSso",
			"DisableSSOPages":   "DisableSsoPages",
			"DisableSSORequest": "DisableSsoRequest",
	...
	"github.com/pendo-io/aws-sdk-go/service/dynamodbstreams": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
			"AWSRegion":               "AwsRegion",
	...
	"github.com/pendo-io/aws-sdk-go/service/dynamodbstreams/dynamodbstreamsiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/pendo-io/aws-sdk-go/service/ec2/ec2iface": {
		operations: map[string]string{
			"AcceptVPCPeeringConnection":           "AcceptVpcPeeringConnection",
			"AcceptVPCPeeringConnectionPages":      "AcceptVpcPeeringConnectionPages",
			"AcceptVPCPeeringConnectionRequest":    "AcceptVpcPeeringConnectionRequest",
	...
	"github.com/pendo-io/aws-sdk-go/service/ecs": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
			"ARN":                   "Arn",
	...
	"github.com/pendo-io/aws-sdk-go/service/ecs/ecsiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/pendo-io/aws-sdk-go/service/efs": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
	...
	"github.com/pendo-io/aws-sdk-go/service/efs/efsiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/pendo-io/aws-sdk-go/service/elasticache": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
	...
	"github.com/pendo-io/aws-sdk-go/service/elasticache/elasticacheiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/pendo-io/aws-sdk-go/service/elasticbeanstalk": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
	...
	"github.com/pendo-io/aws-sdk-go/service/elasticbeanstalk/elasticbeanstalkiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/pendo-io/aws-sdk-go/service/elastictranscoder/elastictranscoderiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/pendo-io/aws-sdk-go/service/elb": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
			"InstanceID":       "InstanceId",
	...
	"github.com/pendo-io/aws-sdk-go/service/elb/elbiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/pendo-io/aws-sdk-go/service/emr": {
		operations: map[string]string{},
		shapes: map[string]string{
	...
	"github.com/pendo-io/aws-sdk-go/service/emr/emriface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/pendo-io/aws-sdk-go/service/glacier/glacieriface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/pendo-io/aws-sdk-go/service/iam": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
			"ARN":                      "Arn",
	...
	"github.com/pendo-io/aws-sdk-go/service/iam/iamiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/pendo-io/aws-sdk-go/service/kinesis/kinesisiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/pendo-io/aws-sdk-go/service/lambda": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
	...
	"github.com/pendo-io/aws-sdk-go/service/lambda/lambdaiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/pendo-io/aws-sdk-go/service/machinelearning/machinelearningiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/pendo-io/aws-sdk-go/service/mobileanalytics": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
			"ID": "Id",
	...
	"github.com/pendo-io/aws-sdk-go/service/mobileanalytics/mobileanalyticsiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/pendo-io/aws-sdk-go/service/opsworks": {
		operations: map[string]string{
	...
	"github.com/pendo-io/aws-sdk-go/service/opsworks/opsworksiface": {
		operations: map[string]string{
			"AssociateElasticIP":             "AssociateElasticIp",
			"AssociateElasticIPPages":        "AssociateElasticIpPages",
			"AssociateElasticIPRequest":      "AssociateElasticIpRequest",
	...
	"github.com/pendo-io/aws-sdk-go/service/rds": {
		operations: map[string]string{},
		shapes: map[string]string{
	...
	"github.com/pendo-io/aws-sdk-go/service/rds/rdsiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/pendo-io/aws-sdk-go/service/redshift": {
		operations: map[string]string{
	...
	"github.com/pendo-io/aws-sdk-go/service/redshift/redshiftiface": {
		operations: map[string]string{
			"CreateHSMClientCertificate":           "CreateHsmClientCertificate",
			"CreateHSMClientCertificatePages":      "CreateHsmClientCertificatePages",
			"CreateHSMClientCertificateRequest":    "CreateHsmClientCertificateRequest",
	...
	"github.com/pendo-io/aws-sdk-go/service/route53/route53iface": {
		operations: map[string]string{
			"GetCheckerIPRanges":        "GetCheckerIpRanges",
			"GetCheckerIPRangesPages":   "GetCheckerIpRangesPages",
			"GetCheckerIPRangesRequest": "GetCheckerIpRangesRequest",
	...
	"github.com/pendo-io/aws-sdk-go/service/route53domains": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
			"DNSSec":           "DnsSec",
	...
	"github.com/pendo-io/aws-sdk-go/service/route53domains/route53domainsiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/pendo-io/aws-sdk-go/service/ses": {
		operations: map[string]string{
	...
	"github.com/pendo-io/aws-sdk-go/service/ses/sesiface": {
		operations: map[string]string{
			"GetIdentityDKIMAttributes":        "GetIdentityDkimAttributes",
			"GetIdentityDKIMAttributesPages":   "GetIdentityDkimAttributesPages",
			"GetIdentityDKIMAttributesRequest": "GetIdentityDkimAttributesRequest",
	...
	"github.com/pendo-io/aws-sdk-go/service/sns/snsiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/pendo-io/aws-sdk-go/service/ssm": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
			"InstanceID": "InstanceId",
	...
	"github.com/pendo-io/aws-sdk-go/service/ssm/ssmiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/pendo-io/aws-sdk-go/service/storagegateway": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
			"DiskID":             "DiskId",
	...
	"github.com/pendo-io/aws-sdk-go/service/storagegateway/storagegatewayiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	...
	"github.com/pendo-io/aws-sdk-go/service/support": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
			"AttachmentID":     "AttachmentId",
	...
	"github.com/pendo-io/aws-sdk-go/service/support/supportiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/pendo-io/aws-sdk-go/service/swf": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
			"ActivityID":                   "ActivityId",
	...
	"github.com/pendo-io/aws-sdk-go/service/swf/swfiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
	"github.com/pendo-io/aws-sdk-go/service/workspaces": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields: map[string]string{
			"BundleID":                 "BundleId",
	...
	"github.com/pendo-io/aws-sdk-go/service/workspaces/workspacesiface": {
		operations: map[string]string{},
		shapes:     map[string]string{},
		fields:     map[string]string{},
	},
